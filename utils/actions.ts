...
export const updateProfileAction = async (prevState: any, formData: FormData): Promise<{ message: string }> => {
  ...
  try {
    ...
    // Old way of validating data, moved to schemas.ts as validateWithZodSchema
...
export const createPropertyAction = async (prevState: any, formData: FormData): Promise<{ message: string }> => {
  ...
  try {
    ...
    await db.property.create({ data: { ...validatedFields, profileId: user.id, image: fullPath } })
...
export const fetchFavorites = async () => {
  ...
  const onlyProperties = favorites.map((favorite) => favorite.property)
...
export async function deleteBookingActions(prevState: { bookingId: string }) {
