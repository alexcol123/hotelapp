...
import { fetchBookings, deleteBookingActions } from '@/utils/actions'
...
if (bookings.length === 0) {
  ...
  return (
    <div className='mt-16'>
      ...
      <Table>
        <TableCaption className='mt-8'>A list of your recent bookings.</TableCaption>
        <TableHeader>
          <TableRow>
...
function DeleteBooking({ bookingId }: { bookingId: string }) {
  const deleteBooking = deleteBookingActions.bind(null, { bookingId })
  return (
