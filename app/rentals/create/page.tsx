      ...
      <div className="border p-8 rounded">
        ...
        <FormContainer action={createPropertyAction}>
          <div className="grid  md:grid-cols-2 gap-8 mb-4">
            ...
            <FormInput name='tagline' type='text' label='Tagline (30 limit)' defaultValue='Dream getaway awaits you! ' />
          ...
          <h3 className="text-lg mt-10 mb-6 font-medium  ">Accomodation Details</h3>
<AmenitiesInput />
